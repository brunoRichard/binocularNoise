...
theBlockData <- list.files(paste0(theDataDirectory,theCompleteParticipants[2]), pattern = "*.mat", full.names = TRUE)
...
```{r}
for (i in 1:dim(avgSNRCondition)[2]){
  plot(avgSNRCondition[,i], type = "l")
}
```
